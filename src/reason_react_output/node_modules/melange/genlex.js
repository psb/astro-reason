...
import * as Stdlib__Stream from "./stream.js";
...
function store(c) {
  if (bufpos.contents >= buffer.contents.length) {
    ...
    Stdlib__Bytes.blit(buffer.contents, 0, newbuffer, 0, bufpos.contents);
...
function get_string(param) {
  var s = Stdlib__Bytes.sub_string(buffer.contents, 0, bufpos.contents);
  buffer.contents = initial_buffer;
  return s;
}

function make_lexer(keywords) {
  var kwd_table = Stdlib__Hashtbl.create(undefined, 17);
  Stdlib__List.iter((function (s) {
          Stdlib__Hashtbl.add(kwd_table, s, {
                TAG: /* Kwd */0,
                _0: s
              });
        }), keywords);
  var ident_or_keyword = function (id) {
    try {
      return Stdlib__Hashtbl.find(kwd_table, id);
    }
    catch (raw_exn){
  ...
  var keyword_or_error = function (c) {
    var s = Caml_bytes.bytes_to_string(Stdlib__Bytes.make(1, c));
    try {
      return Stdlib__Hashtbl.find(kwd_table, s);
    }
    catch (raw_exn){
      var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
      if (exn.RE_EXN_ID === Stdlib.Not_found) {
  ...
  var next_token = function (strm__) {
    while(true) {
      var c = Stdlib__Stream.peek(strm__);
      if (c === undefined) {
        return ;
      }
      var exit = 0;
          ...
          if (c >= 123) {
            ...
            switch (c) {
              ...
              case 39 :
                  ...
                  var match = Stdlib__Stream.peek(strm__);
                  if (match !== undefined) {
                    if (match !== 39) {
                      throw {
                            RE_EXN_ID: Stdlib__Stream.$$Error,
              ...
              case 40 :
                  Stdlib__Stream.junk(strm__);
                  var match$1 = Stdlib__Stream.peek(strm__);
                  if (match$1 === 42) {
                    Stdlib__Stream.junk(strm__);
                    comment(strm__);
              ...
              case 45 :
                  Stdlib__Stream.junk(strm__);
                  var c$2 = Stdlib__Stream.peek(strm__);
      ...
      switch (exit) {
        ...
        case 2 :
            ...
            store(c);
            while(true) {
              var c$3 = Stdlib__Stream.peek(strm__);
              if (c$3 === undefined) {
    ...
    while(true) {
      ...
      if (c !== undefined) {
        if (c >= 58) {
          ...
          store(/* '.' */46);
          while(true) {
            var c$1 = Stdlib__Stream.peek(strm__);
            if (c$1 !== undefined) {
              if (c$1 > 101 || c$1 < 69) {
                if (!(c$1 > 57 || c$1 < 48)) {
                  Stdlib__Stream.junk(strm__);
  ...
  var string = function (strm__) {
    while(true) {
      ...
      throw {
            RE_EXN_ID: Stdlib__Stream.Failure,
            Error: new Error()
          };
    };
  };
  ...
  var $$escape = function (strm__) {
    var c1 = Stdlib__Stream.peek(strm__);
    if (c1 !== undefined) {
      if (c1 >= 58) {
        switch (c1) {
          case 110 :
        ...
        if (c1 >= 48) {
          Stdlib__Stream.junk(strm__);
          var c2 = Stdlib__Stream.peek(strm__);
          if (c2 !== undefined) {
            if (c2 > 57 || c2 < 48) {
              throw {
                    RE_EXN_ID: Stdlib__Stream.$$Error,
            ...
            Stdlib__Stream.junk(strm__);
            var c3 = Stdlib__Stream.peek(strm__);
            if (c3 !== undefined) {
              if (c3 > 57 || c3 < 48) {
                throw {
                      RE_EXN_ID: Stdlib__Stream.$$Error,
              ...
              Stdlib__Stream.junk(strm__);
              return Stdlib__Char.chr((Math.imul(c1 - 48 | 0, 100) + Math.imul(c2 - 48 | 0, 10) | 0) + (c3 - 48 | 0) | 0);
            }
            throw {
                  RE_EXN_ID: Stdlib__Stream.$$Error,
                  _1: "",
      ...
      if (match !== undefined) {
        switch (match) {
          ...
          case 42 :
              Stdlib__Stream.junk(strm__);
              while(true) {
                var match$2 = Stdlib__Stream.peek(strm__);
  ...
  return function (input) {
    return Stdlib__Stream.from(function (_count) {
